...
ggplot(DT_2days,aes(datetime,Global_active_power)) +theme(axis.title.x=element_blank()) +geom_line()+scale_x_datetime(date_labels=("%a"), date_breaks = "1 day") + labs(y="Global active power(kilowatts)")
dev.off()